...
type Args struct {
	Url       string `arg:"-u, --url"          help:"開きたいURL"`
	WinWidth  int    `arg:"-x, --width"        help:"初期ウィンドウ幅" default:"1000"`
	WinHeight int    `arg:"-y, --height"       help:"初期ウィンドウ高さ" default:"800"`
	WinTitle  string `arg:"-t, --title"        help:"ウィンドウタイトル" default:""`
